...
const WakeUp = () => {
    ...
    return (
        <div className='h-[100dvh] w-[100vw] bg-gradient-to-r from-fuchsia-500 to-violet-500 flex flex-col items-center justify-center'>
            <div role="status" >
                <svg aria-hidden="true" class="inline w-20 h-20 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="sr-only" className='font-bold text-white my-4' >Loading...</div>
